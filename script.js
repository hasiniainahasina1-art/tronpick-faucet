    ...
    try {
        ...
        if (error.message.includes('Cookies expirés')) {
            ...
            try {
                ...
                // Relancer immédiatement le claim (attention à la récursion infinie en cas d'échec persistant, on peut limiter)
...
(async () => {
    try {
        ...
        try {
            ...
            if (!result) {
                result = { success: false, message: 'Erreur inconnue (résultat vide)' };
            }
        } catch (e) {
